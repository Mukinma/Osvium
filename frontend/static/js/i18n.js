...
(function () {
  ...
  const DICT_EN = {
    ...
    'Rostro normal': 'Normal face',
    'Cabello recogido': 'Hair tied back',
    'Con casco': 'With helmet',
    'Capturando rostro': 'Capturing face',
    ...
    'Registrar rostro robusto': 'Enroll robust face',
    'Actualizar rostro': 'Update face',
    'Entrenar': 'Train',
    'Ver': 'View',
    ...
    'Atencion': 'Attention',
    'Capturando': 'Capturing',
    'Capturando de frente': 'Capturing front view',
    'Por favor, remueve los lentes': 'Please remove your glasses',
    'Entrenando modelo...': 'Training model...',
    'Las muestras se guardaron': 'Samples saved',
    'El modelo se puede entrenar despues desde Sistema': 'Model can be trained later from System',
    'Modelo actualizado': 'Model updated',
    'muestras de': 'samples from',
    'Guiado': 'Guided',
    'Sesion detenida': 'Session paused',
    'Primero: rostro normal': 'First: normal face',
    'Capturar rostro normal': 'Capture normal face',
    'Ahora con el cabello recogido': 'Now with hair tied back',
    'Ahora con casco': 'Now with helmet',
    'Colócate frente a la cámara': 'Stand in front of the camera',
    'Mantén el rostro visible y espera la captura.': 'Keep your face visible and wait for capture.',
